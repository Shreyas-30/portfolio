  ...
  return (
    ...
    >
      <div className="flex items-end justify-between gap-6">
        ...
        <Link
          href="/work"
          className="group/link inline-flex items-center gap-2 pb-1 font-mono text-[12px] uppercase tracking-[0.14em] text-ink transition-colors hover:text-accent"
          onClick={() =>
            posthog.capture("view_all_work_clicked", {
