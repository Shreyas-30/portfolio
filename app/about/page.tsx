  ...
  return (
    <main className="relative z-[2] mx-auto w-full max-w-3xl px-6 pb-32 pt-20 sm:px-10">
      ...
      <div className="mt-10 max-w-prose space-y-5 text-base leading-relaxed text-ink/80">
        <p>
          I&rsquo;m a generalist who sits at the intersection of engineering,
          design, and business. I recently graduated with a Master&rsquo;s in
          Integrated Product Design from the University of Pennsylvania, a joint
          program across Penn Engineering, Wharton, and the Weitzman School of
          Design.
        </p>
        <p>
          Before Penn, I spent two years as a Technical Analyst at Citi and a
          year consulting on digital solutions for small businesses. I studied
          Information Technology at COEP Technological University, Pune before
          that. Born and raised in Amravati, Maharashtra.
        </p>
        <p>
          I&rsquo;m drawn to problems that sit in the gap between disciplines,
          where the mechanical meets the digital, or where a sharp product idea
          meets the messy reality of getting it built and into people&rsquo;s
          hands.
        </p>
        <p>
          Building a life with room for travel, good people, and the kind of
          work that keeps me curious. I don&rsquo;t really want the work to feel
          separate from the rest of life. Ideally it all feeds into the same
          thing: learning a lot, making useful things, and staying close to
          problems that feel real.
        </p>
      </div>
